package com.xm.admin.generator;

import com.xm.admin.generator.bean.EntityOfEntity;
...
public class Generator {
     ...
     * 建议仅需修改
     */
    private static final String description = "配置";

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "xiaomalover";
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "com.xm.admin.modules.base.entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = "com.xm.admin.modules.base.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "com.xm.admin.modules.base.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "com.xm.admin.modules.base.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "com.xm.admin.modules.base.controller";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        entity.setTableName("sys_"+camel2Underline(className));
